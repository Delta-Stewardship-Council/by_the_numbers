...
#Northern Sierra \# Pulling out percent average for this date
...
#Total Delta Exports: 'total delta exports', average of (CVP + SWP) #When run, will automatically update for current month
